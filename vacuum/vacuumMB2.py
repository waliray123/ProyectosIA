class Vacuum:
    ...
    def __init__(self):
        ...
        self.model = [
            ('vc1', 'ask-for-action-1', 'left', 'vc1'),
            ('vc1', 'ask-for-action-1', 'right', 'vc1-right'),
            ('vc1', 'ask-for-action-1', 'is-clean', 'vc1'),
            ...
            ('vc2', 'ask-for-action-2', 'left', 'vc2-left'),
            ('vc2', 'ask-for-action-2', 'right', 'vc2'),
            ('vc2', 'ask-for-action-2', 'is-clean', 'vc2'),
