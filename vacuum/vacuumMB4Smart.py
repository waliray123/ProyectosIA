...
while(True):
    print("Insert a perception of position")
    perceptionPosition = input()
    print("Insert a perception of cleaning")
    perceptionCleaning = input()
    perception = perceptionPosition + '-' + perceptionCleaning
